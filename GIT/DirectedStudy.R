...
AWC <- "/Users/aidanperkins/Downloads/awc_gNATSGO/awc_gNATSGO_US.tif"
MaizeCover <- "/Users/aidanperkins/Downloads/Proctor/Proctor_1/Data/Crop_Frequency_2008-2023/crop_frequency_corn_2008-2023.tif"
SoyCover <- "/Users/aidanperkins/Downloads/Proctor/Proctor_1/Data/Crop_Frequency_2008-2023/crop_frequency_soybeans_2008-2023.tif"

### datasets
weather_merged <- fread("/Users/aidanperkins/Downloads/Proctor/Proctor_1/Data/weather_2020-09-15.csv")
maize = fread(input = "/Users/aidanperkins/Downloads/Proctor/Proctor_1/Data/Maize_1999_2019_NASS.csv")
soy = fread(input = "/Users/aidanperkins/Downloads/Proctor/Proctor_1/Data/Soy_1999_2020_NASS.csv")
AWC <- rast(AWC)
MaizeCover <- rast(MaizeCover)
SoyCover <- rast(SoyCover)
...
weather_merged = weather_merged[weather_merged$GEOID %in% unique(maize$GEOID),]
...
maize_gs[, County.x := trimws(tolower(County.x))]

# Create a unique key to merge on
maize_gs <- unique(maize_gs[, .(County.x, GEOID)])

# Merge the datasets to add GEOID to AWC_WM
AWC_WM <- merge(AWC_WM, maize_gs, by.x = "County", by.y = "County.x", all.x = TRUE)
...
stargazer(mod0, mod1, mod2, mod3, mod4, type = "text")
...
regression_file_path <- "D:/R_temp/Plots/regression_results.txt"
...
plot(residuals(mod0), main = "Residuals for Model 0", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")

plot(residuals(mod1), main = "Residuals for Model 1", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")

plot(residuals(mod2), main = "Residuals for Model 2", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")

plot(residuals(mod3), main = "Residuals for Model 3", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")

plot(residuals(mod4), main = "Residuals for Model 4", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")

plot(residuals(mod5), main = "Residuals for Model 5", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")

plot(residuals(mod6), main = "Residuals for Model 6", xlab = "Index", ylab = "Residuals")
abline(h = 0, col = "red")
